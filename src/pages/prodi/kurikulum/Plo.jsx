                ...
                <div className="py-2">
                  ...
                  <div className="relative w-full">
                    ...
                    <input
                      ...
                      className="bg-gray-5w-full md:w-72 max-w-96 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block ps-10 p-2.5"
                      placeholder="Search..."
                      required
                    />
                  </div>
