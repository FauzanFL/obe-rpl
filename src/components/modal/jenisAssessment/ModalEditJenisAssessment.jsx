...
import { updateJenisAssessment } from '../../../api/jenisAssessment';

export default function ModalEditJenisAssessment({ close, render, data }) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (validation()) {
      try {
        const res = await updateJenisAssessment(dataInput, data.id);
        if (res) {
