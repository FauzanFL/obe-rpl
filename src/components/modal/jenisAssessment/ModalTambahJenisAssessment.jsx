...
import { createJenisAssessment } from '../../../api/jenisAssessment';

export default function ModalTambahJenisAssessment({ close, render }) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (validation()) {
      try {
        const res = await createJenisAssessment(dataInput);
        if (res) {
